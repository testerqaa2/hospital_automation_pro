...
def login_with_different_session():
    with sync_playwright() as p:
        ...
        try:
            ...
            # Pilih Location: Pharmacy
            print("3. Memilih 'Pharmacy'")
            page.locator("#sessionLocation li#Pharmacy").click()
